  ...
  <body>
    <div class="admin">
      ...
      <div class="logo1">
        <div class="logo2">
          <img
            class="wire-frame-11"
            alt=""
            src="./public/wire-frame-1@2x.png"
          />

          <div class="sacred-heart-of1">
            Sacred Heart of Jesus Catholic School</div>
      ...
      <div class="frame">
        ...
        <button class="log-out" id="lOGOUT"></button>
        ...
        <a href="index.html"><button class="log-out1">
